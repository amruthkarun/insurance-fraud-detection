...
- Made a few cahnges in the frontend to get the values better.
- Successfully am able to summarize why the prediction was made using Gemini 2.5 Flash. (Basic integration of GenAI concepts).
- Summary is based on 3 prominant features that is chosen by SHAP.
